...
class LightningBolt : MonoBehaviour
{
    ...
    public Vector2 Start { get { return ActiveLineObj[0].GetComponent<Line>().StartPos; } }

    //The position where our bolt ended
    public Vector2 End { get { return ActiveLineObj[ActiveLineObj.Count - 1].GetComponent<Line>().EndPos; } }
    ...
    void activateLine(Vector2 A, Vector2 B, float thickness)
    {
        ...
        lineComponent.StartPos = A;
        lineComponent.EndPos = B;
